...
// Child component containing all the original logic
function EditFrameContent() {
                                ...
                                <div className="col-span-2">
                                  ...
                                  <div className="flex items-center gap-2">
                                    <input
                                      ...
                                      className="h-8 w-10 p-0 bg(0,0):nth-child(1) rounded overflow-hidden cursor-pointer"
                                    />
                                    <input
                                      type="text"
                                      value={editorData.textSettings.color}
...
export default function EditFramePage() {
  return (
    <Suspense fallback={<div className="p-4 flex justify-center items-center min-h-screen">Loading frame data...</div>}>
      <EditFrameContent />
    </Suspense>
  );
}